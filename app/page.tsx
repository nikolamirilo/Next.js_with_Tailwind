        ...
        <div className="container mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center" aria-label="Home" role="img">
            <img
              ...
              alt="logo"
            />
            <p className="ml-2 lg:ml-4 text-base lg:text-2xl font-bold text-gray-800 dark:text-white">
              The North
            </p>
          </div>
          <div>
            <button
              ...
              className="dark:bg-white rounded sm:block md:hidden lg:hidden text-gray-500 hover:text-gray-700 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
              <img
                className="h-8 w-8"
            ...
            <div id="menu" className={!isOpen ? "md:block lg:block hidden" : "md:block lg:block"}>
              <button
                onClick={() => setIsOpen(false)}
                className=" dark:bg-white rounded block md:hidden lg:hidden text-gray-500 hover:text-gray-700 focus:text-gray-700 fixed focus:outline-none focus:ring-2 focus:ring-gray-500 bg-white md:bg-transparent z-30 top-0 mt-3"
              >
                <img
                  className="h-8 w-8"
              ...
              <ul className="flex text-3xl md:text-base items-center py-8 md:flex flex-col md:flex-row justify-center fixed md:relative top-0 bottom-0 left-0 right-0 bg-white md:bg-transparent  z-20">
                <li className="text-gray-600 text-lg hover:text-gray-800 dark:text-white cursor-pointer md:ml-10 pt-10 md:pt-0">
